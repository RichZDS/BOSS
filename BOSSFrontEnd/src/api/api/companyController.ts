...
/** 此处后端没有提供注释 POST /company/delete */
export async function deleteCompany(body: API.DeleteRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>('/company/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /company/update */
